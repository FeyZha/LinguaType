...
- 标题改为正文流直接编辑，删除重复主题行、显式编辑按钮、`增强最新一句` 和 `校对提示 Proofreading` 按钮。
- 底部状态栏整合模式、强度、触发、领域、文本统计和本地 proofreading 数量。
...
- 引入统一 Heroicons 风格图标和弹层外部点击关闭机制。
...
- `API Settings 设置`、触发与打扰设置、Data Control 合并到统一设置页；Personal Dictionary 并入表达库类型。
